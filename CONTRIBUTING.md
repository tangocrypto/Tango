Contributing to Tango Core
==================================

The Tango Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Tango Core project, and is not to be
confused with overall Tango Network Protocol consensus changes.

Whether a pull request is merged into Tango Core rests with the project merge
...
Patches that change Tango consensus rules are considerably more involved than
...
Where a patch set proposes to change the Tango consensus, it must have been
...
The project leader is the release manager for each Tango Core release.
