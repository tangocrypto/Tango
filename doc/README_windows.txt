...
Intro
-----
Tango (TNGO) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. Tango utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run tango-qt.exe.

Tango Core is the original Tango client and it builds the backbone of the network.
However, it downloads and stores the entire history of Tango transactions;
