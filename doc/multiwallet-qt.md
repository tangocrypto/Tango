...
In order to support loading of multiple wallets in tango-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is tango.cpp.
...
Changes to tango.cpp
----------------------
tango.cpp is the entry point into tango-qt, and as such, will require some minor modifications to provide hooks for
