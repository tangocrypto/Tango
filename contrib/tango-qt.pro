...
RESOURCES += src/qt/tango.qrc src/qt/tango_locale.qrc

TRANSLATIONS += src/qt/locale/tango_bg.ts \
                src/qt/locale/tango_de.ts \
                src/qt/locale/tango_en.ts \
                src/qt/locale/tango_es.ts \
                src/qt/locale/tango_fi.ts \
                src/qt/locale/tango_fr.ts \
                src/qt/locale/tango_it.ts \
                src/qt/locale/tango_ja.ts \
                src/qt/locale/tango_pl.ts \
                src/qt/locale/tango_pt.ts \
                src/qt/locale/tango_ru.ts \
                src/qt/locale/tango_sk.ts \
                src/qt/locale/tango_sv.ts \
                src/qt/locale/tango_vi.ts \
                src/qt/locale/tango_zh_CN.ts \
                src/qt/locale/tango_zh_TW.ts
