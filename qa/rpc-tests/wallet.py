...
#   c) node1 mines 32 blocks, so now node 0 has 500000TNGO, node 1 has 4250TNGO, node2 has none.
#   d) node0 sends 601 TNGO to node2, in two transactions (301 TNGO, then 300 TNGO).
