...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Tango features */
        {"tango", "masternode", &masternode, true, true, false},
        {"tango", "listmasternodes", &listmasternodes, true, true, false},
        {"tango", "getmasternodecount", &getmasternodecount, true, true, false},
        {"tango", "masternodeconnect", &masternodeconnect, true, true, false},
        {"tango", "masternodecurrent", &masternodecurrent, true, true, false},
        {"tango", "masternodedebug", &masternodedebug, true, true, false},
        {"tango", "startmasternode", &startmasternode, true, true, false},
        {"tango", "createmasternodekey", &createmasternodekey, true, true, false},
        {"tango", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"tango", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"tango", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"tango", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"tango", "getmasternodescores", &getmasternodescores, true, true, false},
        {"tango", "mnbudget", &mnbudget, true, true, false},
        {"tango", "preparebudget", &preparebudget, true, true, false},
        {"tango", "submitbudget", &submitbudget, true, true, false},
        {"tango", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"tango", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"tango", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"tango", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"tango", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"tango", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"tango", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"tango", "checkbudgets", &checkbudgets, true, true, false},
        {"tango", "mnsync", &mnsync, true, true, false},
        {"tango", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> tango-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:9501/\n";
}
