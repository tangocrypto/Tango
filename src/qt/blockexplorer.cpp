...
static std::string ValueToString(CAmount nValue, bool AllowNegative = false)
{
    ...
    QString Str = BitcoinUnits::formatWithUnit(BitcoinUnits::TNGO, nValue);
...
void BlockExplorer::showEvent(QShowEvent*)
{
    if (m_NeverShown) {
        ...
        if (!GetBoolArg("-txindex", false)) {
            QString Warning = tr("Not all transactions will be shown. To view all transactions you need to set txindex=1 in the configuration file (tango.conf).");
            QMessageBox::warning(this, "Tango Core Blockchain Explorer", Warning, QMessageBox::Ok);
        }
    }
}
...
{
    QString CSS = "body {font-size:12px; color:#f09837; bgcolor:#fafafa;}\n a, span { font-family: monospace; }\n span.addr {color:#f09837; font-weight: bold;}\n table tr td {padding: 3px; border: 1px solid black; background-color: #fafafa;}\n td.d0 {font-weight: bold; color:#f09837;}\n h2, h3 { white-space:nowrap; color:#f09837;}\n a { color:#337ab7; text-decoration:none; }\n a.nav {color:#337ab7;}\n";
