...
/** Utility functions used by the Tango Qt UI.
 */
namespace GUIUtil
{
...
// Render TNGO addresses in monospace font
...
// Parse "tango:" URI into recipient object, return true on successful parsing
